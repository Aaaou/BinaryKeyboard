...
| 无线版 CH592F | [无线版固件开发](./wireless/dev.md) / [三模架构](./wireless/trimode.md) | RISC-V 工具链、USB/BLE/2.4G、DataFlash、FN、宏、IAP |
...
| `CH592F-2G4-<MODEL>-TRIMODE-full.bin/.hex` | 三模首次 ISP 完整包 |
| `CH592F-2G4-<MODEL>-TRIMODE-radio-app.bin` | 三模 2.4G OTA 子镜像 |
| `CH592F-2G4-<MODEL>-TRIMODE-ble-app.bin` | 三模 USB/BLE OTA 子镜像 |
...
- 默认层与键位数量正确。
- 键位写入后断电重启仍保留。
- 如果改到无线版，USB / BLE / 2.4G 三种模式都能输入并能在断电后恢复。
